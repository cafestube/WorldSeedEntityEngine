...
//        boneSuppliers.put(name -> true, (info, scale) -> {
//            return new ModelBoneEmote(info.pivot(), info.name(), info.rotation(), this, BONE_TRANSLATIONS.get(info.name()), VERTICAL_OFFSETS.getOrDefault(info.name(), 0.0), skin);
//        });
//    }
//
//    @Override
