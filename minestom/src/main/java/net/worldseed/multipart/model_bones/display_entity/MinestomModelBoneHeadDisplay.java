...
public class MinestomModelBoneHeadDisplay extends ModelBoneHeadDisplay<Player, GenericModel, ModelBone> implements ModelBone {

    public MinestomModelBoneHeadDisplay(Point pivot, String name, Point rotation, GenericModel model, float scale) {
